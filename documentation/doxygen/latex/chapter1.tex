...
Le modèle s’appuie sur un échantillon représentatif de la population française au 1er janvier 2018, construit à partir de l’enquête Histoire de Vie et Patrimoine 2017-2018. Composé d’environ 60 000 individus, cet échantillon initial contient des informations sur les liens familiaux ainsi que l'historique des positions occupées sur le marché du travail.
...
\subsubsection{Réforme de 2023}
\begin{itemize}
	\item Relèvement progressif de l'\textbf{âge d'ouverture des droits} de 2 ans, pour les assurés nés à partir du 1er septembre 1961, à raison de 3 mois supplémentaires par génération, pour atteindre 64 ans à compter de la génération 1968..
	 \begin{itemize}
		\item Il atteindra 59 ans pour les agents relevant de la catégorie active de la fonction publique à compter de la génération 1973.
		\item Il atteindra 54 ans pour les agents relevant de la catégorie super-active de la fonction publique, à compter de la génération 1978. \textit{Dispositif non intégré dans le modèle.}
	 \end{itemize}
	 \item Accélération de l'augmentation de la durée d'assurance requise pour l'obtention du taux plein prévu par la loi n° 2014-40 du 20 janvier 2014, pour les assurés nés à partir du 1er septembre 1961, à raison d'un trimestre par génération contre trois, de façon à atteindre 43 annuités à compter de la génération 1965 au lieu de la génération 1973.
	 \begin{itemize}
		\item Elle atteindra 43 annuités à compter des générations 1970 pour les agents des catégories actives.
		\item Elle atteindra 43 annuités à compter des générations 1975 pour les agents de la catégorie super-active. \textit{Dispositif non intégré dans le modèle.}
	 \end{itemize}
	\item Suppression de la réduction de bonifications en cas de prolongement de l'activité (bonification du cinquième par exemple). \textit{Dispositif non intégré dans le modèle.}
	\item Le dispositif de départ anticipé pour carrières longues compte quatre bornes d'âge s'élevant respectivement à 58, 60, 62 et 63 ans. L'assuré doit justifier d'une durée d'assurance ouvrant droit à une retraite au taux plein et avoir validé quatre à cinq trimestres avant le 31 décembre de ses 16, 18, 20 ou 21 ans.
	\item Abaissement du taux d'incapacité permettant un départ à la retraite pour handicap, passant de 80\% à 50\%. \textit{Dispositif non intégré dans le modèle.}
	\item Abaissement de l'âge d'ouverture des droits dans le cas d'un départ pour incapacité permanente, selon le taux d'incapacité. Si le taux d'incapacité est supérieur à 20\%, l'AOD est à 60 ans. Pour ceux dont le taux d'incapacité est compris entre 10\% et 20\%, l'AOD est à 62 ans. \textit{Dispositif non intégré dans le modèle.}
	\item Les assurés relevant du cumul emploi-retraite intégral pourront bénéficier de nouveaux droits contributifs après avoir liquidé leur pension une première fois. \textit{Dispositif non intégré dans le modèle.}
	\item L'accès à la retraite progressive est élargi à tous les assurés, y compris les fonctionnaires, à partir de 62 ans. L'obligation de durée minimale de travail de 24 heures par semaine est levée. \textit{Dispositif non intégré dans le modèle.}
	\item Création de l'assurance vieillesse aux aidants (AVA). EN plus des aidants éligibles à l'AVPF, de nouveaux bénéficiaires y sont affiliés : les aidants des personnes adultes en situation de handicap, qui ne justifient pas des conditions d'habitation et de lien de parenté; les parents ayant la charge d'un enfant de moins de 20 ans en situation de handicap avec une incapacité permanente d'au moins 80\%; Les parents ayant la charge d’un enfant de moins de 20 ans dont le taux d’incapacité est entre 50\% et 80\% et éligible au complément de l’allocation d’éducation de l’enfant handicapé. \textit{Dispositif non intégré dans le modèle.}
	\item Au minimum deux trimestres de majoration de durée d'assurance au titre de l'éducation ou de l'adoption d'un enfant au bénéfice de la mère. Les parents de l'enfant décédé avant sa quatrième année bénéficient de la majoration d'assurance pour éducation.
	\item Les sapeurs-pompiers volontaires, ayant accompli dix années de service à ce titre, pourront bénéficier d’une bonification de trimestres, qui seront pris en compte dans le calcul du taux de liquidation et dans la durée d’assurance. \textit{Dispositif non intégré dans le modèle.}
	\item Elargissement du dispositif de versement pour la retraite, en incluant les périodes où l'assuré était inscrit en tant que sportif de haut niveau ou membre d'un organe délibérant des collectivités territoriales. \textit{Dispositif non intégré dans le modèle.}
	\item Prise en compte des périodes d’apprentissage qui ont fait l’objet de rachat de trimestres, dans le cas des dispositifs de retraite anticipée pour carrières longues ou pour travailleur handicapé. \textit{Dispositif non intégré dans le modèle.}
	\item Déplafonnement de l'accumulation de points sur le compte professionnel de prévention (C2P), et attribution de davantages de points aux salariés poly-exposés. La reconnaissance du travail de nuit passe de 120 à 100 nuits, et celle du travail en équipes alternantes de 50 à 30 nuits. \textit{Dispositif non intégré dans le modèle.}
	\item Création d'une quatrième utilisation du C2P, permettant aux assurés de mobiliser leurs droits pour le financement d'un congé de reconversion professionnelle. Les périodes où l'assuré prend un congé de reconversion professionnelle seront considérées comme cotisées. \textit{Dispositif non intégré dans le modèle.}
	\item Les majorations de durée d'assurance pour pénibilité seront pris en compte pour la proratisation et non plus seulement dans le taux de liquidation. Néanmoins, elles ne permettront pas d'avoir un départ anticipé à la retraite avant 62 ans. \textit{Dispositif non intégré dans le modèle.}
	\item Le Mico sera revalorisé de 25 euros par mois et la majoration sera revalorisée de 75 euros par mois pour les assurés justifiant d'une carrière complète. Le montant sera proratisé selon la durée d'assurance validée.
	\item Le Mico majoré sera indexé sur le Smic pour le calcul des droits à la liquidation. \textit{Dispositif à contrôler par le biais des hypothèses économiques.}
	\item Les trimestres AVPF et AVA seront réputés cotisés et ainsi pris en compte dans les conditions d'éligibilité et le calcul de la proratisation de la majoration du Mico.
	\item Le montant de la pension majorée de référence (PMR) sera revalorisé à hauteur de 100 euros pour les assurés justifiant d'une carrière complète. \textit{Dipositif non intégré dans le modèle.}
	\item La condition de durée d'assurance requise pour bénéficier du complément différentiel de points de retraite complémentaire obligatoire (CD-RCO) est remplacée par la condition de liquidation à taux plein dans le régime d'assurance vieillesse des personnes non salariées des professions agricoles. \textit{Dispositif non intégré dans le modèle.}
	\item Pour bénéficier de l'allocation de solidarité aux personnes âgés (Aspa), les assurés devront justifier d'une résidence stable et régulière en France d'une durée minimum de 9 mois (contre 6 mois) par an pour en bénéficier. Le seuil de récupération sur succession de l'actif net passe de 39 000 euros à 100 000 euros à compter du 1er septembre 2023. Il reste revalorisé chaque année sur l'évolution de l'indice des prix la consommation hors tabac. \textit{Dispositif non intégré dans le modèle.}
	\item Introduction d'une surcote parentale, permettant d'avoir un droit à surcote l'année précédant l'âge d'ouverture des droits pour les assurés ayant obtenu au moins un trimestre de majoration d'assurance pour enfant, pour éducation ou pour congé parental et lorsque l'AOD est supérieur à 63 ans.
	\item Mise en extinction des régimes spéciaux de retraite des industries électriques et gazières (IEG), de la Régie autonome des transports parisiens (RATP), des clercs et employés de notaire (CRPCEN), de la Banque de France et des membres du Conseil économique, social et environnemental (CESE). Les personnes recrutées par ces entreprises ou institutions seront affiliées au au régime général pour leur retraite de base et à l’Agirc-Arrco pour leur retraite complémentaire, à l’exception des membres du CESE qui seront affiliés à l’IRCANTEC. \textit{Dispositif non intégré dans le modèle.}
\end{itemize}

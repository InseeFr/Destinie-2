...
eco <- new.env()
eco$macro <- read_xls(param_eco,
  c("ParamGene", "ParamRetrBase", "ParamRetrComp", "ParamRev", "ParamAutres", "ParamFam", paste0("cho", scencho, "_pib", scenprod)),
  annee = 1900:fin_simul
)

...
void Leg::leg_priv(const Indiv & X, int age) {
  ...
  VD AgeMinRG2023 = {1960,62.0 , 1968,64.0};
  VD DureeCibRG2023 = { 1933,37.5, 1943,40, 1948,40, 1952,41, 1953,41.25, 1954,41.25, 1955,41.5, 1957,41.5, 1958,41.75,
                        1960,41.75, 1961,42.25, 1962,42.25, 1963,42.5, 1964,42.75, 1965,43 };
  ...
  { 
    ...
    if (an_leg >= 2023 && t >= 123) 
    {
      AgeMinRG = affn(g, AgeMinRG2023);
      DureeCibRG = affn(g, DureeCibRG2023);
      DureeProratRG = DureeCibRG;
      
      if (g == 1961 && X.moisnaiss + 1 < 9)
      {
        AgeMinRG = 62;
        DureeCibRG = 42;
      }		  
  ...
  AgeSurcote = AgeMinRG;
  if(g >= 1964 && X.sexe == FEMME && X.nb_enf(age) > 0 && an_leg >= 2023)
  {
    //Surcote possible a AOD-1 pour femmes avec MDA a partir de la generation 1964 : reforme 2023
    surcote_parentale = true;
  }
  AgeMinInv = AgeMinRG;
  if (an_leg >= 2023 && t >= 123) {
    AgeMinInv = 62;
...
void Leg::leg_pub(const Indiv & X, int age) { // AnOuvDroitFP
  ...
  VD ageouvdroitfp2023 = {1960,62.0, 1968,64.0}; // sédentaires comme RG
  VD AgeMinFP2023 = {1965,57.0, 1973,59.0};      // actifs
  VD DureeCibFP2023 = {1933,37.5, 1943,37.5, 1948,40, 1952,41, 1953,41.25, 1954,41.25, 1955,41.5, 1957,41.5, 1958,41.75,
                       1960,41.75, 1961,42.25, 1962,42.25, 1963,42.5, 1964,42.75, 1965,43};
  VD DureeCibFPA2023 = {1938,37.5 , 1948,37.5, 1949,38,1950,38.5,1951,39,1952,39.5,1953,40,1954,40.25,1955,40.5, 1957,41, 1958,41.25, 1959,41.5,
                        1960,41.5, 1961,41.75, 1963,41.75, 1964,42,
                        1965,42, 1966,42.25, 1967,42.25, 1968,42.5, 1969,42.75, 1970,43};
  ...
  else
  {
    ...
    else if (durfpa>=DureeMinFPA)
    {
      ...
      if (an_leg >= 2023 && t >= 123)
      {
        AgeMinFP = affn(g, AgeMinFP2023);
        DureeCibFP = affn(g, DureeCibFPA2023);
        
        if (g == 1966 && X.moisnaiss + 1 < 9)
        {
          AgeMinFP = 57;
          DureeCibFP = 42;
        }
    ...
    else
    {
      ...
      if (an_leg >= 2023 && t >= 123)
      {
        AgeMinFP = affn(g, ageouvdroitfp2023);
        DureeCibFP = affn(g, DureeCibFP2023);
        DureeProratFP = DureeCibFP;
...
void Leg::leg_dra(const Indiv & X, int age) {
  ...
  static VD ageDRA2023_20 = {1962,60.0, 1970,62.0}; // Augmentation progressive de l'age pour les cotisants avant 20 ans
  ...
  else
  {
    ...
    if (an_leg >= 2023 && t >= 124)
    {
      DureeValCibDRA[0] = DureeCibRG;
      DureeCotCibDRA[0] = DureeCibRG;
      DebActCibDRA[0]   = 16;
      AgeDRA[0] = 58;
      
      DureeValCibDRA[1] = DureeCibRG;
      DureeCotCibDRA[1] = DureeCibRG;
      DebActCibDRA[1]   = 20;
      // Décalage conjoint avec l'AOD
      AgeDRA[1] = affn(g, ageDRA2023_20);
      
      if (g >= 1964) {
        DureeValCibDRA[2] = DureeCibRG;
        DureeCotCibDRA[2] = DureeCibRG;
        DebActCibDRA[2]   = 18;
        AgeDRA[2] = 60;
      } else {
        // On met par défaut à la condition 0
        DureeValCibDRA[2] = DureeCibRG;
        DureeCotCibDRA[2] = DureeCibRG;
        DebActCibDRA[2]   = 16;
        AgeDRA[2] = 58;
